...
:doc:`hrtfpykit.plots <../plots/index>`, plotting functions receive an HRTF
object explicitly and read its active :class:`~hrtfpykit.hrtf.domain.IR`,
:class:`~hrtfpykit.hrtf.domain.TF`, and
:class:`~hrtfpykit.hrtf.sources.Sources` views. Visualizations therefore follow
the file that was loaded, the source positions that were selected, the ear
channels in use, and any transforms already applied without making plotting
part of the core HRTF class. In workflows handled by
