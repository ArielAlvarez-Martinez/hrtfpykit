...
The datasets API is hrtfpykit's spec-driven construction layer for HRTF
...
directly to PyTorch data loaders and similar batching pipelines.  The API is
...
The datasets API builds on the :doc:`hrtf API <../hrtf/index>` for acoustic
...
With this API, users can choose a concrete dataset integration, select local and
