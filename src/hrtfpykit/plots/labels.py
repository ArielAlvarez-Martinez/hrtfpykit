...
class Labels:
    ...
    hertz. Time-domain impulse-response plots use seconds or sample indices
    ...
    time, samples : str
        X-axis labels for impulse-response plots in seconds or discrete sample
        indices.
    impulse_response : str
        Default y-axis label for time-domain HRIR amplitude plots.
    itd_seconds, ild_db : str
        Radial labels for absolute ITD and absolute ILD polar plots.
