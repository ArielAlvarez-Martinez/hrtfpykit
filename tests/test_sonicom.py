...
_ALL_COMBINATIONS: list[tuple[tuple[object, ...], tuple[object, ...]]] = [
    ...
    ((ITDSpec(index_by=("subject", "position"), positions="all", plane=("horizontal", 0.0), transform=_identity),), ()),
    (
        (
            ILDSpec(
                index_by=("subject", "frequency", "position"),
    ...
    (
        (
            ...
            ITDSpec(index_by=("subject", "position"), positions=(0, 1, 2), position_index=True, transform=_identity),
        ),
        (ILDSpec(index_by=("subject", "position"), mode="broad-band", positions=(0, 1, 2), position_index=True, transform=_identity),),
    ),
]
